...
import GopiBugs.taskcontrol.impl.TaskControllerImpl;
 ...
 *
 */
public class GopiBugsClient extends GopiBugsCore implements Runnable {

    private Logger logger = Logger.getLogger(this.getClass().getName());
    private Vector<GopiBugsModule> moduleSet;
    // make GopiBugsClient a singleton
    private static GopiBugsClient client = new GopiBugsClient();

    public GopiBugsClient() {
    }

    public static GopiBugsClient getInstance() {
        return client;
    }
    ...
    public void run() {
        ...
        try {
            ...
            logger.info("GopiBugs starting with " + numberOfNodes + " computation nodes");
            ...
            // save static references to GopiBugsCore
            GopiBugsCore.taskController = taskControllerr;
            //GineuCore.ioController = ioController;
            GopiBugsCore.desktop = desktop;
            ...
            moduleSet = new Vector<GopiBugsModule>();
            ...
            GopiBugsCore.initializedModules = moduleSet.toArray(new GopiBugsModule[0]);
        ...
        desktop.setStatusBarText("Welcome to GopiBugs!");
    ...
    public GopiBugsModule loadModule(String moduleClassName) {
        ...
        try {
            ...
            // create instance
            GopiBugsModule moduleInstance = (GopiBugsModule) moduleClass.newInstance();
