...
public class GopiBugsHelpMap implements Map {
        ...
        public void setTarget(String target) {
                String url;
                if (test) {
                        url = "jar:file:" + System.getProperty("user.dir") + "/dist/GopiBugs.jar!/" + target;
                } else {
                        url = "jar:file:" + System.getProperty("user.dir") + "/GopiBugs.jar!/" + target;
                }
