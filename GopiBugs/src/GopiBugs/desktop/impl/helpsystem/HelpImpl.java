...
package GopiBugs.desktop.impl.helpsystem;
...
public class HelpImpl {
    ...
    public HelpImpl() {
        try {
            ...
            File file = new File(System.getProperty("user.dir")
                    + File.separator + "GopiBugs.jar");

            if (!file.exists()) {
                file = new File(System.getProperty("user.dir") + File.separator
                        + "dist" + File.separator + "GopiBugs.jar");
                test = true;
            }
            ...
            GopiBugsHelpMap helpMap = new GopiBugsHelpMap(test);
            ...
            hs = new GopiBugsHelpSet();
            hs.setLocalMap(helpMap);

            GopiBugsTOCView myTOC = new GopiBugsTOCView(hs, "TOC",
                    "Table Of Contents", helpMap, file);

            hs.setTitle("GopiBugs");
            hs.addTOCView(myTOC);
    ...
    public GopiBugsHelpSet getHelpSet() {
        return hs;
    }
