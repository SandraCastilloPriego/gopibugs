 ...
 *
 */
public class GopiBugsTOCView extends TOCView {

        private GopiBugsHelpMap hm;
        private HelpSet hs;
        private File file;

        public GopiBugsTOCView(HelpSet hs, String name, String label, GopiBugsHelpMap hm, File file) {
