 ...
 */
public interface Desktop extends GopiBugsModule {
         ...
         *
         * @param parentMenu GopiBugsMenu where to create the new item
        ...
        /**
         * Adds a separator to a given GopiBugs menu
         *
