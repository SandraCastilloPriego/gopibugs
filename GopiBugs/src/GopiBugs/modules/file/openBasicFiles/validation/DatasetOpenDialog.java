...
package GopiBugs.modules.file.openBasicFiles.validation;
...
public class DatasetOpenDialog extends JDialog implements ActionListener {
	...
	public DatasetOpenDialog(File lastpath) {
		...
		super(GopiBugsCore.getDesktop().getMainFrame(),
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (command.equals("ApproveSelection")) {			
			try {
                                ...
                                DesktopParameters deskParameters = (DesktopParameters) GopiBugsCore
