...
public class WriteFile {
         ...
         */
        public void WriteCommaSeparatedFileLCMS(BugDataset dataset, String path, SimpleParameterSet parameters) {
                try {
         ...
         * @param parameters Parameters for saving the file (columns saved in the new file)
         */
        public void WriteExcelFileLCMS(BugDataset dataset, String path, SimpleParameterSet parameters) {
       ...
       /**
         ...
         * @param parameters Parameters for saving the file (columns saved in the new file)
         */
        public void WriteExcelFileGCGC(BugDataset dataset, String path, SimpleParameterSet parameters) {
                FileOutputStream fileOut = null;
                try {
                        HSSFWorkbook wb;
                        HSSFSheet sheet;
         ...
         * @param parameters Parameters for saving the file (columns saved in the new file)
         */
        public void WriteCommaSeparatedFileGCGC(BugDataset dataset, String path, SimpleParameterSet parameters) {
                try {
                        Object elementsObjects[] = (Object[]) parameters.getParameterValue(SaveGCGCParameters.exportGCGC);
                        parameters.setParameterValue(SaveGCGCParameters.exportGCGC, elementsObjects);
