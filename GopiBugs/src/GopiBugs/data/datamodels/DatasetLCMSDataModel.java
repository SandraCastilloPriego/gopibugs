...
import GopiBugs.data.IdentificationType;
...
public class DatasetLCMSDataModel extends AbstractTableModel implements DataTableModel {
        ...
        public DatasetLCMSDataModel(BugDataset dataset) {
        ...
        public void setParameters() {
                ...
                fixNumberColumns = 0;
                this.LCMSViewParameters = (LCMSColumnsViewParameters) ((DesktopParameters) GopiBugsCore.getDesktop().getParameterSet()).getViewLCMSParameters();
