...
import GopiBugs.util.components.ExtendedCheckBox;
import GopiBugs.util.components.HelpButton;
...
public class ParameterSetupDialog extends JDialog implements ActionListener {
        ...
        public ParameterSetupDialog(String title, SimpleParameterSet parameters,
                ...
                // Make dialog modal
                super(GopiBugsCore.getDesktop().getMainFrame(), title, true);
                ...
                pack();
                setLocationRelativeTo(GopiBugsCore.getDesktop().getMainFrame());
                                ...
                                btnFileBrowser.addActionListener(new ActionListener() {
                                        ...
                                        public void actionPerformed(ActionEvent e) {
                                                ...
                                                int returnVal = fileChooser.showDialog(
                                                        GopiBugsCore.getDesktop().getMainFrame(), "Select");
        ...
        public void actionPerformed(ActionEvent ae) {
                ...
                if (src == btnOK) {
                        try {
                                ...
                                GopiBugsCore.getDesktop().displayErrorMessage(
